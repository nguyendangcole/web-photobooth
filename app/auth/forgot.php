...
if ($_SERVER['REQUEST_METHOD']==='POST'){
  ...
  if (!$err){
    ...
    if ($u){
      ...
      send_mail($email,'Reset mật khẩu',"Click link để reset: <a href=\"$link\">$link</a>");
      $msg='Đã gửi email hướng dẫn (nếu email tồn tại).';
    } else {
      $msg='Đã gửi email hướng dẫn (nếu email tồn tại).';
    }
  }
...
<div class="container py-5">
  ...
  <form method="post" class="mt-3">
    ...
    <button class="btn btn-primary mt-3">Gửi link reset</button>
  </form>
</div>
