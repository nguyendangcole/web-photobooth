...
function buildDeclarativeTween(_a) {
  ...
  if ("to" in op) {
    if (timelineAndPosition.timeline) {
      ...
      gsap.gsap.to(target, __spreadProps(__spreadValues({}, op.to), { id, duration, paused }));
    }
  } else if ("from" in op) {
    if (timelineAndPosition.timeline) {
      ...
      gsap.gsap.from(target, __spreadProps(__spreadValues({}, op.from), { id, duration, paused }));
    }
  ...
  return () => {
    var _a3;
    (_a3 = gsap.gsap.getById(id)) == null ? void 0 : _a3.revert();
  };
}
var clsx = (...classes) => {
...
exports.buildDeclarativeTween = buildDeclarativeTween;
exports.clsx = clsx;
exports.getTweenTarget = getTweenTarget;
exports.internalEventEmmiter = internalEventEmmiter;
exports.isDev = isDev;
