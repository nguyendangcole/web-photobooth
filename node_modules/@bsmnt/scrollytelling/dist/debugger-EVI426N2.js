...
var chunk6D7OEZDO_js = require('./chunk-6D7OEZDO.js');
var react = require('react');
var gsap = require('gsap');
var jsxRuntime = require('react/jsx-runtime');
var reactPortal = require('@radix-ui/react-portal');

// esbuild-scss-modules-plugin:./visualizer.module.scss
...
// src/components/debugger/visualizer/helpers.tsx
...
var Tween = ({
  ...
  react.useEffect(() => {
    ...
    return chunk6D7OEZDO_js.internalEventEmmiter.on("timeline:update", handleUpdate);
...
var Waypoint = ({
  ...
  const [lastState, setLastState] = react.useState(void 0);
  react.useEffect(() => {
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntime.jsx(
          "span",
          {
            className: chunk6D7OEZDO_js.clsx(
        ...
        /* @__PURE__ */ jsxRuntime.jsx(
          "span",
          {
            className: chunk6D7OEZDO_js.clsx(visualizer_module_default["onCall"], lastState === "complete" && visualizer_module_default["active"]),
            children: /* @__PURE__ */ jsxRuntime.jsx(
              "svg",
              {
                width: "12",
...
var Select = (props) => {
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: visualizer_module_default["selectWrapper"], children: [
    /* @__PURE__ */ jsxRuntime.jsx("select", chunk6D7OEZDO_js.__spreadProps(chunk6D7OEZDO_js.__spreadValues({}, props), { className: chunk6D7OEZDO_js.clsx(visualizer_module_default["select"], props.className) })),
    /* @__PURE__ */ jsxRuntime.jsx(
      "svg",
      {
...
var Visualizer = () => {
  ...
  const panelHeaderRef = react.useRef(null);
  ...
  react.useEffect(() => {
    return chunk6D7OEZDO_js.internalEventEmmiter.on("timeline:refresh", () => {
      const roots2 = [];
      gsap.gsap.globalTimeline.getChildren().forEach((t) => {
        var _a2;
  ...
  react.useEffect(() => {
    chunk6D7OEZDO_js.internalEventEmmiter.emit("timeline:refresh");
  }, []);
  if (dismiss)
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "div",
    {
      className: chunk6D7OEZDO_js.clsx(visualizer_module_default["root"], initialized && visualizer_module_default["initialized"]),
      ref: panelRef,
      children: [
        /* @__PURE__ */ jsxRuntime.jsxs("header", { className: visualizer_module_default["header"], ref: panelHeaderRef, children: [
          /* @__PURE__ */ jsxRuntime.jsxs("div", { className: visualizer_module_default["actions"], children: [
            /* @__PURE__ */ jsxRuntime.jsx(
              Select,
              {
                value: selectedRoot,
                ...
                children: roots.map((r) => {
                  return /* @__PURE__ */ jsxRuntime.jsx("option", { value: r.id, children: r.label }, r.id);
                })
              }
            ),
            /* @__PURE__ */ jsxRuntime.jsx("div", { className: visualizer_module_default["actions"], children: /* @__PURE__ */ jsxRuntime.jsxs(
              "button",
              {
                className: chunk6D7OEZDO_js.clsx(visualizer_module_default["button"], visualizer_module_default["scrollToRoot"]),
                onClick: () => {
                  var _a2, _b;
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntime.jsx("span", { className: visualizer_module_default["text"], children: "SCROLL TO ROOT" })
                ]
              }
            ) })
          ] }),
          /* @__PURE__ */ jsxRuntime.jsxs("div", { className: visualizer_module_default["actions"], children: [
            /* @__PURE__ */ jsxRuntime.jsx(
              "button",
              {
                ...
                children: minimize ? /* @__PURE__ */ jsxRuntime.jsxs(
                  "svg",
                  {
                    viewBox: "0 0 16 16",
                    fill: "none",
            ...
            /* @__PURE__ */ jsxRuntime.jsx("button", { className: visualizer_module_default["button"], onClick: () => setDismiss(true), children: /* @__PURE__ */ jsxRuntime.jsx(
              "svg",
              {
                viewBox: "0 0 16 16",
                fill: "none",
        ...
        !minimize && /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
          /* @__PURE__ */ jsxRuntime.jsx("main", { className: visualizer_module_default["main"], children: /* @__PURE__ */ jsxRuntime.jsxs("div", { className: visualizer_module_default["timeline"], children: [
            /* @__PURE__ */ jsxRuntime.jsxs("div", { className: visualizer_module_default["guides"], children: [
              /* @__PURE__ */ jsxRuntime.jsx("div", { className: visualizer_module_default["guide"], style: { left: "0%" }, children: /* @__PURE__ */ jsxRuntime.jsx("span", { className: visualizer_module_default["percent"], children: "0%" }) }),
              /* @__PURE__ */ jsxRuntime.jsx("div", { className: visualizer_module_default["guide"], style: { left: "25%" }, children: /* @__PURE__ */ jsxRuntime.jsx("span", { className: visualizer_module_default["percent"], children: "25%" }) }),
              /* @__PURE__ */ jsxRuntime.jsx("div", { className: visualizer_module_default["guide"], style: { left: "50%" }, children: /* @__PURE__ */ jsxRuntime.jsx("span", { className: visualizer_module_default["percent"], children: "50%" }) }),
              /* @__PURE__ */ jsxRuntime.jsx("div", { className: visualizer_module_default["guide"], style: { left: "75%" }, children: /* @__PURE__ */ jsxRuntime.jsx("span", { className: visualizer_module_default["percent"], children: "75%" }) }),
              /* @__PURE__ */ jsxRuntime.jsx("div", { className: visualizer_module_default["guide"], style: { left: "100%" }, children: /* @__PURE__ */ jsxRuntime.jsx("span", { className: visualizer_module_default["percent"], children: "100%" }) })
            ] }),
            /* @__PURE__ */ jsxRuntime.jsx("div", { className: visualizer_module_default["tweens"], children: root == null ? void 0 : root.children.map((t, idx) => {
              const data = t.data;
              if (data.type === "animation") {
                return /* @__PURE__ */ jsxRuntime.jsx("div", { className: visualizer_module_default["row"], children: /* @__PURE__ */ jsxRuntime.jsx(Tween, { tween: t, root, idx }) }, idx);
              }
              if (data.type === "waypoint") {
                return /* @__PURE__ */ jsxRuntime.jsx("div", { className: visualizer_module_default["row"], children: /* @__PURE__ */ jsxRuntime.jsx(Waypoint, { tween: t, root, idx }) }, idx);
              }
              return /* @__PURE__ */ jsxRuntime.jsx(jsxRuntime.Fragment, {});
            }) }),
            /* @__PURE__ */ jsxRuntime.jsxs("div", { className: visualizer_module_default["progress"], children: [
              /* @__PURE__ */ jsxRuntime.jsx("div", { className: visualizer_module_default["marker"], ref: markerRef, children: /* @__PURE__ */ jsxRuntime.jsxs("span", { className: visualizer_module_default["thumb"], children: [
                /* @__PURE__ */ jsxRuntime.jsx("span", { className: visualizer_module_default["percent"], children: /* @__PURE__ */ jsxRuntime.jsx(ProgressStatus, { root }) }),
                /* @__PURE__ */ jsxRuntime.jsxs(
                  "svg",
                  {
                    width: "8",
                    ...
                    xmlns: "http://www.w3.org/2000/svg",
                    children: [
                      /* @__PURE__ */ jsxRuntime.jsx("mask", { id: "path-1-inside-1_2793_1632", fill: "white", children: /* @__PURE__ */ jsxRuntime.jsx(
                        "path",
                        {
                          fillRule: "evenodd",
                          clipRule: "evenodd",
              ...
              /* @__PURE__ */ jsxRuntime.jsx("div", { className: visualizer_module_default["trail"], children: /* @__PURE__ */ jsxRuntime.jsx("div", { className: visualizer_module_default["gradient"], ref: trailRef }) })
            ] })
          ] }) }),
          /* @__PURE__ */ jsxRuntime.jsxs("footer", { className: visualizer_module_default["footer"], children: [
            /* @__PURE__ */ jsxRuntime.jsxs("span", { children: [
              "Visualizer",
              /* @__PURE__ */ jsxRuntime.jsxs("span", { className: visualizer_module_default["version"], children: [
                " (v.",
...
function Debugger() {
  const [mountInstance, setMountInstance] = react.useState(false);
  react.useEffect(() => {
    const w = window;
  ...
  if (!mountInstance)
    return /* @__PURE__ */ jsxRuntime.jsx(jsxRuntime.Fragment, {});
  return /* @__PURE__ */ jsxRuntime.jsx(reactPortal.Portal, { children: /* @__PURE__ */ jsxRuntime.jsx(Visualizer, {}) });
}
